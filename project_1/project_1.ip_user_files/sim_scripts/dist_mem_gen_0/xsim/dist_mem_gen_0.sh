...
#
# Script generated by Vivado on Sun Jan 05 11:58:03 +0200 2025
...
# script info
echo -e "dist_mem_gen_0.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2 -L uvm -L dist_mem_gen_v8_0_15 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot dist_mem_gen_0 xil_defaultlib.dist_mem_gen_0 xil_defaultlib.glbl -log elaborate.log
}
