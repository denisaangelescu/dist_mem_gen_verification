...
namespace XILINX_DPI { 
	...
	void dpiInitialize()
	{
		...
		DPIRelocateDPIScopeIP(0, (char*)(0x40e800)) ;
...
extern "C" {
	...
	extern void subprog_m_a9dabdb_556ead11_2262(char*, char*, char*);
}
...
extern "C" {
...

	{
		...
		SP = DPIInitializeFunction(IP + 423816, 168, 240536) ;
		char driver0[32] ;
		...
		DPIInvokeFunction(IP + callingProcessOffset, SP, (void*)(subprog_m_a9dabdb_556ead11_2262), IP) ;
